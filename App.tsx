        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-brand-600 text-sm leading-relaxed">
                Upload a photo of the Saree, Lehenga, or Suit you want to try. A clear image of the garment (flat or on a mannequin) works best.
              </p>
            </div>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-brand-100">
            ...
            <ImageUploader 
              id="cloth-upload"
              label="Outfit Photo (Saree/Lehenga/Etc)" 
                    ...
                    {!result.loading ? (
                      <>
                        ...
                        <p className="text-brand-400 font-light max-w-xs">
                          Upload a photo of yourself and a photo of one of our Sarees or Lehengas.
                        </p>
                      </>
                    ) : (
