    ...
    <div className="min-h-screen bg-[#f9f8f6] text-slate-800 font-sans pb-20">
      ...
      <ResultModal
        ...
        onReset={() => {
          ...
          // Optional: if we want to reset inputs too, call handleReset()
          // handleReset();
        }}
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 mb-2">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center text-brand-700 font-serif font-bold">1</div>
                <h2 className="text-xl font-serif text-brand-900">Upload Photo</h2>
              </div>
              <ImageUploader
                id="person-upload"
                label=""
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 mb-2">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center text-brand-700 font-serif font-bold">2</div>
                <h2 className="text-xl font-serif text-brand-900">Choose Outfit</h2>
              </div>
              ...
              <div className="flex-1">
                {!clothingImage.previewUrl ? (
                  <button
                    ...
                    className="w-full h-80 rounded-xl border-2 border-dashed border-brand-200 hover:border-brand-400 hover:bg-brand-50 transition-all flex flex-col items-center justify-center gap-4 group cursor-pointer"
                  >
                  ...
                  <div className="relative h-80 w-full rounded-xl overflow-hidden border border-brand-200 shadow-sm group bg-white">
                    <img
          ...
          <div className="mt-12 flex justify-center">
            <div className="w-full max-w-md">
              <Button
                ...
                fullWidth
                className="py-4 text-lg shadow-xl shadow-brand-200/50"
              >
                {result.loading ? (
                  <>
                  ...
                  <>
                    <span className="font-serif tracking-wide">Try It On Now</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
